...
class UserRef {
  ...
  User? value;
  UserRef(this.id);
  factory UserRef.fromId(final String id) => UserRef(id);
...
class SignUp {
  ...
  factory SignUp.fromJson(final Map<String, dynamic> json) =>
